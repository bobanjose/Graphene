...
namespace Graphene.Tests.Reporting
{
    ...
    public class QueryTest
    {
        ...
        public void IntegrationTest_GivenFilters_AggreagetedResultsMatch()
        {
            ...
            Graphene.Configurator.Initialize(
                      new Configuration.Settings() { Persister = new Publishing.PersistToMongo("mongodb://localhost:9001/Graphene"), 
                          ReportGenerator = new Graphene.Mongo.Reporting.MongoReportGenerator("mongodb://localhost:9001/Graphene") }
                  );
        ...
        public void IntegrationTest_GivenFiltersAndNamedTrackers_AggreagetedResultsMatch()
        {
            ...
            Graphene.Configurator.Initialize(
                      new Configuration.Settings() { Persister = new Publishing.PersistToMongo("mongodb://localhost:9001/Graphene"), ReportGenerator = new Graphene.Mongo.Reporting.MongoReportGenerator("mongodb://localhost:9001/Graphene") }
                  );
    ...
    public class ReportSpecificationTests
    {
         ...
         public void GivenAQueryWithTwoFilters_WhenBuildingTheList_AppropriateFiltersAreConverted()
         {
             ...
             ReportSpecification<CustomerFilter,CustomerVisitTracker> visitTrackerReportSpecification = new ReportSpecification<CustomerFilter,CustomerVisitTracker>(DateTime.Now,DateTime.UtcNow, ReportResolution.Day, filter1,filter2);
         ...
         public void GivenAQueryWithTrackerProperties_WhenBuildingTheListOfTrackersToTrack_OnlyTheAppropriateCountersAreCounted()
         {
             ...
             var visitTrackerReportSpecification = new ReportSpecification<CustomerFilter, TrackerWithCountProperties>(DateTime.Now, DateTime.UtcNow, ReportResolution.Day);
